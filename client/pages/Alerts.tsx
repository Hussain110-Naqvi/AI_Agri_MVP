...
const alertsData = [
  {
    ...
    message: "Nitrogen Fertilizer inventory has dropped below the reorder threshold (50 units remaining)",
    severity: "high",
    time: "2 minutes ago",
    isRead: false,
    category: "Inventory",
  ...
  },
  {
    ...
    message: "Heavy rainfall expected in your area may affect field operations this week",
    severity: "low",
    time: "5 hours ago",
    isRead: false,
    category: "Weather",
  ...
  },
  {
    ...
    message: "New products available from Farm Equipment Co - Special discount available",
    severity: "low",
    time: "1 day ago",
    isRead: true,
    category: "Supplier",
...
const alertStats = [
  ...
  { label: "High Priority", value: 3, icon: AlertTriangle, color: "bg-red-500" },
  { label: "Resolved Today", value: 12, icon: CheckCircle, color: "bg-green-500" },
];
...
export default function Alerts() {
  ...
  const filters = [
    ...
    { id: "high", label: "High Priority", count: alerts.filter(a => a.severity === "high").length },
    { id: "inventory", label: "Inventory", count: alerts.filter(a => a.category === "Inventory").length },
    { id: "market", label: "Market", count: alerts.filter(a => a.category === "Market").length },
  ];
          ...
          <Card className="bg-white border border-[#E5E8EB] shadow-sm">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-lg font-bold text-[#0D1C17] font-['Lexend']">
                {selectedFilter === "all" ? "All Alerts" : 
                 filters.find(f => f.id === selectedFilter)?.label || "Alerts"} 
            ...
            <CardContent className="p-0">
              {filteredAlerts.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-[#45A180] font-['Lexend']">No alerts found</p>
                </div>
              ) : (
                  ...
                  {filteredAlerts.map((alert) => (
                    ...
                    >
                      <div className="flex items-start gap-3 sm:gap-4">
                        {/* Alert Icon */}
                        <div className={`w-10 h-10 rounded-lg ${getSeverityColor(alert.severity)} flex items-center justify-center flex-shrink-0`}>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
                            <div className="flex items-center gap-2 flex-wrap">
                              <h3 className={`text-sm sm:text-base font-bold font-['Lexend'] ${
                                !alert.isRead ? "text-[#0D1C17]" : "text-[#45A180]"
                              }`}>
                                {alert.title}
                              </h3>
                              <Badge 
                          ...
                          {alert.affectedItems.length > 0 && (
                            <div className="mb-3">
                              <p className="text-xs text-[#45A180] font-['Lexend'] mb-1">Affected Items:</p>
