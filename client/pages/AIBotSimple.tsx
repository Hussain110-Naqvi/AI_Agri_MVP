  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">AI Assistant (Simple)</h1>
        <div className="bg-white rounded-lg border p-6">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="font-semibold text-blue-900 mb-2">🤖 AI Bot Features:</h3>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-green-800">
                Backend integration ready • Waiting for BigQuery credentials • Gemini API ready
              </p>
            </div>
          </div>
